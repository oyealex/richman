...
def run_tui_game(
    ...
    """Assemble config and launch RichmanTuiApp in game mode.

    Engine and players are deferred — SetupScreen creates them after user
    confirms player count and name.
    """
